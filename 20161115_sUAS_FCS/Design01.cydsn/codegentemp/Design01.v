...
module SPI_Master_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("16cb1a30-819e-4a79-9f39-17a24c180ed4/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module top ;
    ...
    SPI_Master_v2_50_1 SPIM (
        ...
        .clock(1'b0),
        .reset(1'b0),
        .rx_interrupt(Net_1226),
        .sdat(Net_1227),
        .tx_interrupt(Net_1228));
    ...
    UART_v2_50_2 DEBUG_UART (
        ...
        .reset(1'b0),
        .rx(Net_27),
        .tx_interrupt(Net_524),
        .rx_interrupt(Net_525),
        .tx_data(Net_526),
        .tx_clk(Net_527),
        .rx_data(Net_528),
        .rx_clk(Net_529));
	...
	wire [0:0] tmpOE__DEBUG_UART_RX_net;
	wire [0:0] tmpIO_0__DEBUG_UART_RX_net;
	wire [0:0] tmpINTERRUPT_0__DEBUG_UART_RX_net;
	electrical [0:0] tmpSIOVREF__DEBUG_UART_RX_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUG_UART_RX
		 (.oe(tmpOE__DEBUG_UART_RX_net),
		  .y({1'b0}),
		  .fb({Net_27}),
		  .io({tmpIO_0__DEBUG_UART_RX_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUG_UART_RX_net),
		  .interrupt({tmpINTERRUPT_0__DEBUG_UART_RX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUG_UART_RX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DEBUG_UART_TX_net;
	wire [0:0] tmpFB_0__DEBUG_UART_TX_net;
	wire [0:0] tmpIO_0__DEBUG_UART_TX_net;
	wire [0:0] tmpINTERRUPT_0__DEBUG_UART_TX_net;
	electrical [0:0] tmpSIOVREF__DEBUG_UART_TX_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ed092b9b-d398-4703-be89-cebf998501f6"),
		  ...
		  .input_buffer_sel(2'b00))
		DEBUG_UART_TX
		 (.oe(tmpOE__DEBUG_UART_TX_net),
		  .y({Net_22}),
		  .fb({tmpFB_0__DEBUG_UART_TX_net[0:0]}),
		  .io({tmpIO_0__DEBUG_UART_TX_net[0:0]}),
		  .siovref(tmpSIOVREF__DEBUG_UART_TX_net),
		  .interrupt({tmpINTERRUPT_0__DEBUG_UART_TX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DEBUG_UART_TX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SPIM_MOSI_net;
	wire [0:0] tmpFB_0__SPIM_MOSI_net;
	wire [0:0] tmpIO_0__SPIM_MOSI_net;
	wire [0:0] tmpINTERRUPT_0__SPIM_MOSI_net;
	electrical [0:0] tmpSIOVREF__SPIM_MOSI_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		SPIM_MOSI
		 (.oe(tmpOE__SPIM_MOSI_net),
		  .y({Net_1254}),
		  .fb({tmpFB_0__SPIM_MOSI_net[0:0]}),
		  .io({tmpIO_0__SPIM_MOSI_net[0:0]}),
		  .siovref(tmpSIOVREF__SPIM_MOSI_net),
		  .interrupt({tmpINTERRUPT_0__SPIM_MOSI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SPIM_MOSI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ecaf7dea-cfe8-46a3-8e5c-8173e8ac95a0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a3ac95fd-5cbc-450d-9fd8-d1604cd8b1aa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9aecad71-0b51-49f5-8988-669507af733a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
